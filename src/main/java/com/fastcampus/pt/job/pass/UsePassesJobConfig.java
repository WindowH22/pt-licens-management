...
import com.fastcampus.pt.repository.booking.BookingRepository;
import com.fastcampus.pt.repository.booking.BookingStatus;
import com.fastcampus.pt.repository.pass.PassEntity;
import com.fastcampus.pt.repository.pass.PassRepository;
...
public class UsePassesJobConfig {
    ...
    public Step usePassesStep(){
        return this.stepBuilderFactory.get("usePassesStep")
                ...
                .processor(usePassesAsyncProcessor())
    ...
    public JpaCursorItemReader<BookingEntity> usePassesItemReader(){
        return new JpaCursorItemReaderBuilder<BookingEntity>()
                ...
                // 상태(status)가 완료이며, 종료일시(endedAt)이 과거인 예약이 이용권 차감 대상이 된다.
                .queryString("select b from BookingEntity b join fetch b.passEntity where b.status = and b.usedPass = false and b.endedAt < :endedAt")
    ...
    @Bean
    public AsyncItemProcessor<BookingEntity,BookingEntity> usePassesAsyncProcessor(){
    ...
    public ItemWriter<BookingEntity> usePassesItemWriter(){
        return bookingEntities -> {
            for(BookingEntity bookingEntity : bookingEntities){
                ...
                //잔여 횟수가 업데이트 완료되면 ,이용권 사요 여부를 업데이트합니다.
                if(updatedCount > 0 ){
